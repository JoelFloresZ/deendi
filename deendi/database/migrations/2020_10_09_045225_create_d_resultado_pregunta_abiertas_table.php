...
class CreateDResultadoPreguntaAbiertasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('d_resultado_pregunta_abiertas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('d_resultado_pregunta_abiertas');
    }
}
