<template>
    ...
    <form method="POST" action="" id="form_pregunta_multiple" v-on:submit.prevent="registraPregunta">
   
    <!-- Modal -->
    <div class="modal fade" id="form-multiple" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input type="hidden" name="tipoResPregunta" id="tipoResPregunta" value="pre_multiple">
            ...
            <div>   
                ...
                <div>
                    <button type="button" class="btn btn-outline-light btn-sm rounded-circle" id="addOpcionesSimple" @click="agregarCampos"><i class="fa fa-plus-circle text-info h5"></i></button>
                </div>   
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            registraPregunta() {
                const DATOS = $('#form_pregunta_multiple').serialize();
                console.log(DATOS);
