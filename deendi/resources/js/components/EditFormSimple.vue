        ...
        <div class="form-group">
            ...
            <textarea name="pregunta" id="edit_pregunta" class="form-control" required="">{{datos.pregunta}}</textarea>
             ...
             <div>
                ...
                <div>
                    <button type="button" class="btn btn-outline-light btn-sm border-0" id="addOpcionesSimple" @click="agregarCampos">
                        <i class="fa fa-plus-circle text-info h5"></i></button>
                </div>
