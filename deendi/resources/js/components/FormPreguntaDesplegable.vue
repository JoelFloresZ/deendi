<template>
    ...
    <form method="POST" action="" id="form_pregunta_desplegable" v-on:submit.prevent="registraPregunta">
   
    <!-- Modal -->
    <div class="modal fade" id="form-desplegable" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input type="hidden" name="tipo_pregunta" id="tipo_pregunta" value="pre_desplegable">
            <input type="hidden" name="tipoResPregunta" id="tipoResPregunta" value="pre_desplegable">
            
            <div class="form-group">
                <label id="pregunta">Pregunta:</label>
                <textarea name="pregunta" id="pregunta" class="form-control"  rows="1" v-model="pregunta" required=""></textarea>
            </div>
            ...
            <div>   
                ...
                <div>
                    <button type="button" class="btn btn-outline-light btn-sm d-flex align-items-center" id="addOpcionesSimple" @click="agregarCampos"><i class="fa fa-plus-circle text-info h5"></i></button>
                </div>   
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            registraPregunta() {
                const DATOS = $('#form_pregunta_desplegable').serialize();
                console.log(DATOS);
