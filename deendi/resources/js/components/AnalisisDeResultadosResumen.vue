        ...
        <div v-for="pregunta in resultados">
            ...
            <div v-if="pregunta.tipo_pregunta === 'pre_archivo'">
                ...
                <div class="row flex-wrap">
                    <div v-for="imagen in pregunta.resultados" class="col-sm-2 col-1">
                        <a :href="imagen.imagen" data-lightbox="roadtrip" :data-title="imagen.nombre_img">
                            <figure>
                                <img :src="imagen.imagen" class="w-75" style="width:100px;">
                            </figure>
                        </a>
                    </div>
                </div> 
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <!-- <div v-for="imagen in pregunta.resultados">
                            <figure>
                            <img :src="imagen.imagen" class="img-fluid img-thumbnail" data-lightbox="roadtrip">
                            </figure>
                        </div> -->
                      </div>
